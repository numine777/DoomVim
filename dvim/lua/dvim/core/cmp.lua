  ...
  dvim.builtin.cmp = {
    ...
    formatting = {
      ...
      format = function(entry, vim_item)
        ...
        vim_item.menu = dvim.builtin.cmp.formatting.source_names[entry.source.name]
        vim_item.dup = dvim.builtin.cmp.formatting.duplicates[entry.source.name]
          or dvim.builtin.cmp.formatting.duplicates_default
        return vim_item
      end,
    },
    snippet = {
    ...
    mapping = {
      ...
      ["<CR>"] = cmp.mapping(function(fallback)
        if cmp.visible() and cmp.confirm(dvim.builtin.cmp.confirm_opts) then
          return
        end
